...
napi_value SettingsPack::Objectify(napi_env env, libtorrent::settings_pack const& settings)
{
    ...
    SET_VALUE_PROPERTY_BOOL(sp, settings, dht_enforce_node_id);
    SET_VALUE_PROPERTY_BOOL(sp, settings, dht_extended_routing_table);
    SET_VALUE_PROPERTY_BOOL(sp, settings, dht_ignore_dark_internet);
    SET_VALUE_PROPERTY_BOOL(sp, settings, dht_prefer_verified_node_ids);
    SET_VALUE_PROPERTY_BOOL(sp, settings, dht_privacy_lookups);
    SET_VALUE_PROPERTY_BOOL(sp, settings, dht_read_only);
    SET_VALUE_PROPERTY_BOOL(sp, settings, dht_restrict_routing_ips);
    SET_VALUE_PROPERTY_BOOL(sp, settings, dht_restrict_search_ips);
    ...
    SET_VALUE_PROPERTY_BOOL(sp, settings, piece_extent_affinity);
    ...
    SET_VALUE_PROPERTY_INT32(sp, settings, dht_item_lifetime);
    SET_VALUE_PROPERTY_INT32(sp, settings, dht_max_dht_items);
    SET_VALUE_PROPERTY_INT32(sp, settings, dht_max_fail_count);
    SET_VALUE_PROPERTY_INT32(sp, settings, dht_max_infohashes_sample_count);
    SET_VALUE_PROPERTY_INT32(sp, settings, dht_max_peers);
    SET_VALUE_PROPERTY_INT32(sp, settings, dht_max_peers_reply);
    SET_VALUE_PROPERTY_INT32(sp, settings, dht_max_torrent_search_reply);
    SET_VALUE_PROPERTY_INT32(sp, settings, dht_max_torrents);
    SET_VALUE_PROPERTY_INT32(sp, settings, dht_sample_infohashes_interval);
    SET_VALUE_PROPERTY_INT32(sp, settings, dht_search_branching);
    ...
    SET_VALUE_PROPERTY_INT32(sp, settings, utp_cwnd_reduce_timer);
